...
- `service`: validation, authentication, eligibility, matching, lifecycle rules
- `dao`: SQL, transactions, persistence mapping
- `model`: domain entities and enums
- `util`: configuration, sessions, navigation, password hashing, dialogs, database bootstrap
...
- Automatically run ranked matching
- View matched donors and reasons
...
- Approve, suspend, activate, and reset user passwords
- Escalate or close requests
- View audit events
